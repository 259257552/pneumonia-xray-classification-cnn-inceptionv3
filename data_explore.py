...
# Normal
sns.histplot(df_all[df_all['label'] == 'NORMAL'], x='mean', bins=20, kde=True, label='Normal', ax = ax[0])
ax[0].legend()
ax[0].set_title('Distribution of Mean Pixel Intensities for NORMAL')

# Pneumonia
sns.histplot(df_all[df_all['label'] == 'PNEUMONIA'], x='mean', bins=20, kde=True, label = 'Pneumonia', ax = ax[1])
ax[1].legend()
ax[1].set_title('Distribution of Mean Pixel Intensities for PNEUMONIA')

# Both
sns.histplot(df_all[df_all['label'] == 'NORMAL'], x='mean', bins=20, kde=True, label='Normal',  ax = ax[2])
sns.histplot(df_all[df_all['label'] == 'PNEUMONIA'], x='mean', bins=20, kde=True, label = 'Pneumonia', ax = ax[2])
ax[2].legend()
...
# Normal
sns.histplot(df_all[df_all['label'] == 'NORMAL'], x='std', bins=20, kde=True, label='Normal', ax=ax[0])
ax[0].legend()
ax[0].set_title('Distribution of Std Pixel Intensities for NORMAL')

# Pneumonia
sns.histplot(df_all[df_all['label'] == 'PNEUMONIA'], x='std', bins=20, kde=True, label='Pneumonia', ax=ax[1])
ax[1].legend()
ax[1].set_title('Distribution of Std Pixel Intensities for PNEUMONIA')

# Both
sns.histplot(df_all[df_all['label'] == 'NORMAL'], x='std', bins=20, kde=True, label='Normal', ax=ax[2])
sns.histplot(df_all[df_all['label'] == 'PNEUMONIA'], x='std', bins=20, kde=True, label='Pneumonia',ax=ax[2])
ax[2].legend()
...
sns.histplot(df_all, x='height', bins=20, kde=True, ax=ax[0])
sns.histplot(df_all, x='width', bins=20, kde=True, ax=ax[1])
ax[0].set_title('Image height distribution')
ax[1].set_title('Image width distribution')

sns.histplot(df_all[df_all['dataset'] == 'NORMAL'], x='mean', bins=20, kde=True, label='Normal', ax = ax[0])
fig, ax = plt.subplots(2,2, figsize=(10, 8))

sns.histplot(df_all[df_all['dataset'] == 'train'], x='height', bins=20, kde=True, ax = ax[0, 0])
ax[0, 0].set_title('Image height distribution - Train')

sns.histplot(df_all[df_all['dataset'] == 'train'], x='width', bins=20, kde=True, ax = ax[0, 1])
ax[0, 1].set_title('Image width distribution - Train')

sns.histplot(df_all[df_all['dataset'] == 'test'], x='height', bins=20, kde=True, ax = ax[1, 0])
ax[1, 0].set_title('Image height distribution - Test')

sns.histplot(df_all[df_all['dataset'] == 'test'], x='width', bins=20, kde=True, ax = ax[1, 1])
